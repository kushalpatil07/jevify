...
<p align="center">
<a href="examples/hotdog"><img src="examples/hotdog/media/not-hotdog.gif" width="300" alt="Not Hotdog demo on jevify"></a><br>
<sub><a href="examples/hotdog">examples/hotdog</a>: the Not Hotdog app, one image and two questions per call, with a live camera mode.</sub>
</p>
